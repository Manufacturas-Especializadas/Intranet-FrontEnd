...
const Navbar = () => {
  ...
  return (
    <nav className="bg-primary shadow-sm sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="p-2 rounded-md text-white/80 hover:bg-white/20 hover:text-white"
            >
      ...
      <div
        className={`md:hidden bg-primary text-white transition-all duration-500 ease-in-out ${
          isMobileMenuOpen ? "max-h-screen py-3" : "max-h-0"
        } overflow-hidden`}
      >
                  ...
                  <div>
                    ...
                    <div
                      className={`transition-all duration-300 ease-in-out ${
                        isMobileDropdownOpen ? "max-h-96 mt-1" : "max-h-0"
                      } overflow-hidden`}
                    >
